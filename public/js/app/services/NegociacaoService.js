...
System.register(['../models/Negociacao', '../daos/NegociacaoDAO', './ConnectionFactory', './HttpService'], function (_export, _context) {
	"use strict";

	var Negociacao, NegociacaoDAO, ConnectionFactory, HttpService, _createClass, NegociacaoService;
